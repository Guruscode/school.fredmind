         ...
         <div class="row align-items-center g-5">
               ...
               <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                  ...
                  <div class="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
                     <a data-glightbox data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-round btn-primary-shadow mb-0 overflow-visible me-7">
                        ...
                        <h6 class="mb-0 ms-3 fw-normal position-absolute start-100 top-50 translate-middle-y">View Courses</h6>
                     </a>
                  </div>
               </div>
            </div>
            ...
            <div class="col-lg-7 col-xl-6 text-center position-relative">
               ...
               <div class="position-relative">
                  <img src="assets/images/element/07111.png" alt="">
               </div>
            </div>
            <!-- Right content END -->
         </div>
      ...
      <div class="container">
         ...
         <div class="row mb-4">
            <div class="col-lg-8 mx-auto text-center">
               <h2 class="fs-1">Trending Courses</h2>
            </div>
         </div>
         <div class="row">
            <!-- Slider START -->
               ...
               <div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items="3" data-items-lg="2" data-items-sm="1">
                  ...
                  <div>
                     <div class="card action-trigger-hover border bg-transparent">
                        <!-- Image -->
                        <img src="{{asset('assets/images/courses/4by3/14.jpg')}}" class="card-img-top" alt="course image">
                        <!-- Ribbon -->
                        <!-- Card body -->
                        <div class="card-body pb-0">
                           ...
                           --}}
                           <!-- Title -->
                           <h5 class="card-title"><a href="#">The Launchpad program is riddled with in-depth insights and knowledge into the many career paths available to you within the tech landscape.</a></h5>
                           <!-- Rating -->
                           <!-- Time -->
                        ...
                        <div class="card-footer pt-0 bg-transparent">
                           ...
                           <div class="d-flex justify-content-between align-items-center">
                              ...
                              <div class="d-flex align-items-center">
                                 ...
                                 <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">Name Lecturer</a></p>
                              </div>
                              <!-- Price -->
                              <div>
                                 <h4 class="text-success mb-0 item-show">Free</h4>
                                 <a href="#" class="btn btn-sm btn-success-soft item-show-hover"><i class="fa fa-play"></i>Learn more</a>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row mt-0 mt-xl-5">
                  ...
                  <div class="col-md-7 position-relative mb-0 mt-0 mt-md-5">
                     ...
                     <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                        ...
                        <blockquote>
                           <p>
                              <span class="me-1 small"><i class="fas fa-quote-left"></i></span> Moonlight newspaper up its enjoyment agreeable depending. Timed voice share led him to widen noisy young. At weddings believed laughing
               ...
               <div class="row mt-5 mt-xl-0">
                  ...
                  <div class="col-md-5 mt-n6 mb-0 mb-md-5">
                     <div class="bg-body shadow text-center p-4 rounded-3">
                        ...
                        <blockquote>
                           <p>
                              <span class="me-1 small"><i class="fas fa-quote-left"></i></span> At weddings believed laughing although the Moonlight newspaper up its enjoyment agreeable depending.
                              <span class="ms-1 small"><i class="fas fa-quote-right"></i></span>
                           </p>
                        </blockquote>
                        <!-- Rating -->
