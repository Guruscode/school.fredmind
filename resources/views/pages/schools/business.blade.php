...
<section class="hero bg-dark text-white d-flex align-items-center" style="height: 100vh; background-image: url('{{asset('ass_asset/img/image14.jpg')}}'); background-size: cover; background-position: center;">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 text-center text-lg-start glassmorphism">
        <h1 class="display-3 font-weight-bold">Welcome to the School of Business!</h1>
        <p class="lead">Prepare for a rewarding career in the creative economy. We offer various courses that equip you with the knowledge and skills required to start, switch, or boost your career.</p>
        <a href="#learn-more" class="btn btn-primary btn-lg mt-4" style=" background-color:white !important; color:black !important; border-radius: 20px !important">Start Learning</a>
      </div>
    </div> 
...
<section class="py-5">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <h2 class="text-center mb-5">The School of Engineering</h2>
...
<section class="py-5">
  <div class="container">
    <h2 class="text-center mb-5"><b>Our Programs</b></h2>
    <div class="row">
      <div class="col-md-4">
