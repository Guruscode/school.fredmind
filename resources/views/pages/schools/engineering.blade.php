...
<section class="hero bg-dark text-white d-flex align-items-center" style="height: 100vh; background-image: url('{{asset('ass_asset/img/focused.jpg')}}'); background-size: cover; background-position: center;">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 text-center text-lg-start glassmorphism">
        <h1 class="display-3 font-weight-bold">Welcome to the School of Engineering!</h1>
        <p class="lead">Prepare for a rewarding career in tech. We offer various technical courses that equip you with the knowledge and skills required to start, switch, or boost your career.</p>
